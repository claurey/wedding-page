    ...
    <>
        ...
        <div className='d-flex text-center justify-content-center flex-wrap' style={{gap:'50px'}}>
            ...
            <div className='d-flex flex-column justify-content-center'>
               ...
               <div className='pb-3 fs-4 text-center' style={{color:"#c2937f"}}>
                <SvgIcon component={ChurchRoundedIcon} fontSize='large'/> </div>

                <h3 className='pb-2' style={{fontFamily:"'Quattrocento', cursive", color: "#c2937f" , fontSize:"24px"}}>La Mansión del Fundador</h3>
        ...
        <button style={{padding:"10px", color:"white", width:'150px',border:"none", borderRadius: "40px", background:" #91652f", boxShadow: "inset 5px 5px 10px #91652f,inset -5px -5px 10px #91652f"}}>
