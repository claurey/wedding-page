...
const Sociales = () => {
  return (
    <>
                ...
                <p className='text-center pb-2 px-2'>Comparte tus fotos y videos de este hermoso día, utiliza el</p>

                <h4 className='text-center pb-3' style={{fontSize:"1.8rem", color:"#d2b49a"}}>#moshisday</h4>
